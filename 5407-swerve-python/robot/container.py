    ...
    def __init__(self):
        ...
        module_params = (
            CTRESwerveModuleParameters(
                ...
                angle_offset=Rotation2d.fromDegrees(199.8),
            ...
            CTRESwerveModuleParameters(
                ...
                relative_position=Translation2d(wheel_base / 2, -track_width / 2),
                angle_offset=Rotation2d.fromDegrees(115.7),
            ...
            CTRESwerveModuleParameters(
                ...
                relative_position=Translation2d(-wheel_base / 2, track_width / 2),
                angle_offset=Rotation2d.fromDegrees(163.7),
            ...
            CTRESwerveModuleParameters(
                ...
                relative_position=Translation2d(-wheel_base / 2, -track_width / 2),
                angle_offset=Rotation2d.fromDegrees(151.7),
